...
% Vitesse de lacet y1 et position latérale y2
[t,y] = ode45(@(t,y) Model_MNL(t, y, Mt, Iz, Lf, Lr, cyf, cyr, lambda, Vx0, Amp, T), tspan, y0);
...
function dydt = Model_MNL(t, y, Mt, Iz, Lf, Lr, cyf, cyr, lambda, Vx0, Amp, T)
    if (t >= 0.2) && (t <= 8.2)
