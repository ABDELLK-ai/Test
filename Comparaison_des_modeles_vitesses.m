...
% %% Affichage pour une vitesse de 90 km/h
% % Position latérale 
% figure(Fig)
% Fig=Fig+1;
% plot(t*Vx0(5),Y5(:))
% title("Position latérale Y_G")
% xlabel('t(s)')
% ylabel('Y_G(m)')
% axis([0 250 0 4])
% grid on
...
legend('10 km/h','30 km/h','50 km/h','70 km/h','90 km/h','110 km/h','130 km/h')
title('Modèle circulaire : Bode entre en la position latérale et l''angle du volant')
grid on
...
legend('10 km/h','30 km/h','50 km/h','70 km/h','90 km/h','110 km/h','130 km/h')
title('Modèle circulaire : Bode entre en la vitesse de lacet et l''angle du volant')
grid on
